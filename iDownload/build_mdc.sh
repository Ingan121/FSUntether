...
clang -arch arm64 -isysroot ~/theos/sdks/iPhoneOS14.5.sdk -o TestFlightServices server-dylib.m -DMDC -framework MobileCoreServices -framework Foundation -Lbuild -lhelpers -lexploit -lgfda -dynamiclib
