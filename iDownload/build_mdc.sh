...
clang -arch arm64 -isysroot ~/theos/sdks/iPhoneOS14.5.sdk -o TestFlightServices server-dylib-mdc.m -framework CoreFoundation -framework SpringBoardServices -framework MobileCoreServices -framework Foundation -F ~/theos/sdks/iPhoneOS14.5.sdk/System/Library/PrivateFrameworks -Lbuild -lhelpers -lexploit -lgfda -dynamiclib
